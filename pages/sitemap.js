...
export default class extends Component {
    ...
    restartPm2Request = () => {
        ...
        restartPm2Process(function(apiResponse) {
            if (apiResponse.submitError) {
                self.setState({restartPm2Loading: false, restartPm2Error: true, restartPm2Sucess: false})
            } else if (!apiResponse.authSuccess) {
                window.location.href = "/login"
            } else if (!apiResponse.success) {
                self.setState({restartPm2Loading: false, restartPm2Error: true, restartPm2Sucess: false})
            } else {
                self.setState({restartPm2Loading: false, restartPm2Error: false, restartPm2Sucess: true})
            }
        })
    }
                        ...
                        <div className="sitemap-form-container">
                            <div className="sitemap-form-section">
                                ...
                                <div className="sitemap-form-description">
                                    <span>This will write new content to the sitemap.xml file</span>
                                </div>
